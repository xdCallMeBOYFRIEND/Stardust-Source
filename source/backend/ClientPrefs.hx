...
@:structInit class SaveVariables {
	...
	public var foreverCombo:Bool = true;
	...
	public var holdSkin:String = 'Vanilla'; //Why is this here
	...
	public var opaqueSustains:Bool = true;
	public var longerHealth:Bool = false;
...
class ClientPrefs {
	...
	public static function loadPrefs() {
		...
		#end
		//Had a bunch of shit here but I saw that it should auto-save if you put the variable into the save variables tab so
		//If I revert this then it's because it fucked up everything
